...
df=nxcals.DevicePropertyQuery.system('CMW')\
...
# basic query
df=nxcals.VariableQuery.system("CMW").variable("CPS.TGM:CYCLE")\
        .startTime("2018-06-15 23:00:00.000").endTime("2018-06-16 00:00:00.000")\
        .buildDataset()


# basic query
df = nxcals.VariableQuery\
...
nxcals._cern.nxcals.service.client.api.VariableService.findBySystemNameAndVariableNameLike("CMW","%I_MEAS%")
...
ds=nxcals.DevicePropertyQuery.system('CMW')\
